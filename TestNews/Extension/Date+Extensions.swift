...
extension Date {
    ...
    var dayMonthYearRepresentation: String {
        return stringFromDateFormat("dd/MM/YYYY")
    }
    
    var yearMonthDateRepresentation: String {
        return stringFromDateFormat("YYYY/MM/dd")
    }
    ...
    func isTomorow(_ date: Date) -> Bool {
    ...
    static func getFormattedDateTracking(string: String) -> String {
...
extension Date {
    ...
    var isInLastMonth: Bool {
        return self.isInSameMonth(as: Date().getPreviousMonth() ?? Date())
    }
